...
## Вывод:
Попробовала новую архитектуру для решения задачи обнаружения проливов. Качество получилось немного хуже, чем было в [реализации автоэнкодеров](https://github.com/starminalush/itmo-processing-and-generating-images-2023/tree/hw_2), потому, что я убрала некоторые аугментации. Можно добить TNR выше, нужно просто добавить еще аугментаций (и покрутить параметры у модели MNAD)
